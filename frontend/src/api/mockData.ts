...
const mockWarehouses: Warehouse[] = [
  {
    ...
    status: 'active',
    contactEmail: 'la-warehouse@logitower.com',
  ...
  },
  {
    ...
    status: 'active',
    contactEmail: 'ny-warehouse@logitower.com',
  ...
  },
  {
    id: 'wh-3',
    code: 'WH-CHI',
    name: 'Chicago Cross-Dock Center',
    type: 'cross_dock',
    address: {
    ...
    status: 'active',
    contactEmail: 'chi-warehouse@logitower.com',
    contactPhone: '+1-555-0103',
    operatingHours: { open: '07:00', close: '21:00', timezone: 'America/Chicago' },
...
const generateReturns = (count: number): Return[] => {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      pickupAddress: {
        street: `${Math.floor(Math.random() * 9000) + 1000} Return St`,
        city: 'New York',
        state: 'NY',
        postalCode: '10001',
        country: 'USA',
